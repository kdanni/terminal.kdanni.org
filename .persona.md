...
- Avoid cross-cutting “frameworks” until 3+ places need the pattern.
...
- If it’s a new module: a **usage snippet** is added to `README` or module docstring.
...
- Prefer **MySQL** for master data persistence.
- Prefer **PostgreSQL + TimescaleDB** for time series data persistence.
